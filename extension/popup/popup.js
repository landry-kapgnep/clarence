...
var FILE_TYPES = {
  ...
  pdf: { mime: "text/markdown;charset=utf-8", text: false, load: () => import("./pdf-adapter-FFWDI37D.js"), outExt: ".md" },
...
async function retirerDuMasquage(valeur) {
  ...
  try {
    ...
    let mapping;
    if (r.mode === "pdf") {
      const { reconstructPdf } = await import("./pdf-reconstruct-3DOTZGQI.js");
